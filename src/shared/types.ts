...
export interface Settings { locale: 'zh-CN' | 'en'; enabled: { quota: boolean; notes: boolean; bookmarks: boolean; artwork?: boolean; theme?: boolean; motion?: boolean; translation?: boolean; workspaces?: boolean }; panelPinned: boolean; appearance?:Appearance }
...
export interface StoredState { version: 1; revision: number; settings: Settings; notes: Note[]; bookmarks: Bookmark[]; translations?:TranslationRecord[]; library?:ToolRecord[] }
...
export type Action = 'ui.ready' | 'note.save' | 'note.delete' | 'bookmark.save' | 'bookmark.delete' | 'settings.patch' | 'quota.refresh' | 'open.link' | 'ui.detach' | 'translate' | 'translation.clear' | 'library.save' | 'library.delete' | 'assist' | 'mobile' | 'resource.reveal';
